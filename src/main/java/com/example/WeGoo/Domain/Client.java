...
public class Client {
	...
	public Client(int id, String firstName, String lastName, String gender,
			@NotNull(message = "The phone is required") @Size(min = 10, max = 15) String phoneNo,
			@NotNull(message = "The National ID is required") @Size(min = 16, max = 16) String nid,
			...
			String dob, String password, String role, String status) {
		super();
		this.id = id;
